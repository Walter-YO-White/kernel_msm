 ...
 */
unsigned int red_whites_val = 7;
unsigned int green_whites_val = 7;
unsigned int blue_whites_val = 7;
 ...
 */
unsigned int red_mids_val = 119;
unsigned int green_mids_val = 119;
unsigned int blue_mids_val = 119;
 ...
 */
unsigned int contrast_val = 22;
unsigned int brightness_val = 2;
